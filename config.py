...
# --- Agent Configuration ---
CONTEXT_LIMIT_CUMULATIVE_FINDINGS = int(
    os.environ.get("CONTEXT_LIMIT_CUMULATIVE_FINDINGS", 30000)
)
CONTEXT_LIMIT_TOOL_RESULTS = int(os.environ.get("CONTEXT_LIMIT_TOOL_RESULTS", 25000))
assert (
    CONTEXT_LIMIT_TOOL_RESULTS < CONTEXT_LIMIT_CUMULATIVE_FINDINGS
)  # must be less than CONTEXT_LIMIT_CUMULATIVE_FINDINGS
MODEL_CONTEXT_LENGTH = (
    30000 + CONTEXT_LIMIT_CUMULATIVE_FINDINGS + CONTEXT_LIMIT_TOOL_RESULTS
)
...
print(f"  IDENTITY_REVISION_TASK_INTERVAL={IDENTITY_REVISION_TASK_INTERVAL}") # <<<--- ADDED PRINT